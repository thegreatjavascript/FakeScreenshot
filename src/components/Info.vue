<template>
  <div id='write' class='is-mac'>
    <blockquote>
      <p><strong>这是一个可以“伪造”微博、知乎、豆瓣、简书等网站界面截图的网站</strong></p>
    </blockquote>
    <p><strong>如何使用？</strong></p>
    <ol>
      <li>点击“编辑内容”按钮</li>
      <li>修改名称、内容、头像等相关信息</li>
      <li>点击“生成截图”按钮</li>
      <li>点击“下载图片”按钮</li>
    </ol>
    <p>&nbsp;</p>
    <p><strong>为什么要做这样一个网站？</strong></p>
    <p>为了告诉（不懂编程的）普通人：不要轻易相信网上看到的“截图”！</p>
    <p><strong>如何做到这一点？</strong></p>
    <p>网站本身的存在，告诉（浏览本网站的用户）人们一件事：所有网站的页面截图都可以非常容易地伪造，且足以乱真！</p>
